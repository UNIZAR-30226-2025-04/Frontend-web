...
export const jokerDirectory:Joker[] = [
    {name:"Error joker", image:"icons/missing.png",tooltip:"This is an error",rarity:0},
    {name:"Solid seven joker",image:"cards/jokers/7.gif",tooltip:"+7 chips +7 mult",rarity:0},
    {name:"Poor joker",image:"cards/jokers/poor joker.png",tooltip:"Generates 4 gold each hand",rarity:0},
    {name:"Petpet",image:"cards/jokers/pet-pet-petpet.gif",tooltip:"Sums the number of gold the user has to mult",rarity:0},
    {name:"Average size michael",image:"cards/jokers/banana.gif",tooltip:"1/15 chance of +15 mult",rarity:0},
    {name:"Hell cowboy",image:"cards/jokers/hell.gif",tooltip:"Adds +mult equivalent to the highest scoring card",rarity:0},
    ...
    {name:"Two friends joker",image:"cards/jokers/doge.gif",tooltip:"Takes 10 of your +chips and changes them to +mult",rarity:0},
    ...
    {name:"Lirili Larila",image:"cards/jokers/lirili.gif",tooltip:"+2 to to mult for each played / scoring 2 then x2 mult",rarity:1},
    ...
    {name:"bicicleta",image:"cards/jokers/bicicleta.gif",tooltip:"Each 2 gives +2 mult and +20 chips",rarity:1},
    ...
    {name:"nasus",image:"cards/jokers/nas.gif",tooltip:"Multiplies your mult by the gold",rarity:2},
